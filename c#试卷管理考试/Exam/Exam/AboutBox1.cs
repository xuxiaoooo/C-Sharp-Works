...
namespace Exam
{
    partial class AboutBox1 : Form
    {
        ...
        {
            this.Text = "高中生期末考试模拟系统";
            this.labelProductName.Text = "学生考试系统";
            this.labelVersion.Text = String.Format("版本 {0}", "  1.0.0");
            this.labelCopyright.Text = "吴静文";
            this.labelCompanyName.Text = "安徽三联学院";
            this.textBoxDescription.Text = "本系统主要针对学生考试而设计，考试过程中简单易用，实现随机抽取试题，自动评分等功能！";
        }
