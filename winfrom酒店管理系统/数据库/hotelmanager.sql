...
-- Records of fonts
-- ----------------------------
INSERT INTO `fonts` VALUES (0, '用户0');
INSERT INTO `fonts` VALUES (1, '用户1');
...
-- Records of reser
-- ----------------------------
INSERT INTO `reser` VALUES ('rs0001', '用户1', '110', '互联网', '情侣套房', 388.00, '2019-12-14 13:30:41.000000', 2);
INSERT INTO `reser` VALUES ('rs0002', '用户2', '10086', '手机客户端', '总统套房', 688.00, '2019-12-16 13:30:41.000000', 1);
INSERT INTO `reser` VALUES ('rs0003', '用户3', '10010', '电话', '标准单人间', 1088.00, '2019-12-18 23:04:40.000000', 1);
...
CREATE TABLE `spend`  (
  `SpendId` int NOT NULL AUTO_INCREMENT,
  `RoomNo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `userinfo` VALUES ('TS1628', '姜文昊', '男', '110', 0, '8008208820', '北京大学', '15:40', 0);
